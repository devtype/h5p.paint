...
| `canvas.brushDefaults.paletteColors` | List of 1–5 HEX colors when `colorMode` is `palette` (add/remove in the editor). Color pickers allow typing HEX via Spectrum `showInput`. The default brush color is always shown first to learners. |
